    ...
    public static void sendMail(String to, String validateUrl) throws Exception {
        ...
        Session session = Session.getDefaultInstance(props, new Authenticator() {
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                 ...
                 * 创建一个邮箱账号
                 */
                return new PasswordAuthentication("13906569268@163.com", "taieo950119");
            }
         ...
         */
        message.setFrom(new InternetAddress("13906569268@163.com"));
         ...
         */
        message.setContent(
                "<h1>您的网站名</h1>邮箱验证请点击以下链接： <h3><a href="
                        + validateUrl + ">激活链接" + validateUrl + "</a></h3>",
